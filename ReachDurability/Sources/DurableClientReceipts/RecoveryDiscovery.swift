...
extension DurableClientReceipts {
    func recoveryBinding(_ binding: RecoveryBinding) throws {
        ...
        guard !binding.authorityOnly && !binding.nativeRecovery, environment.authorityMode != .recoveryAuthority, (environment.authorityMode == .independent) == binding.independent, binding.pair == environment.pairDigest else { throw RecoveryError.invalid }
