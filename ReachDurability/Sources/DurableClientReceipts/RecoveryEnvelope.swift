...
enum RecoveryEncryption {
    struct AAD: Encodable { let revision:String; let binding:RecoveryBinding; let record:String, context:String; let issued:UInt64, expires:UInt64; let retention: String? }
    ...
    static func seal(_ ticket:Data, live:LiveClientRecord, record:String, binding:RecoveryBinding, root:SymmetricKey) throws -> Data {
        ...
        let body=RecoveryEnvelopeBody(version: try binding.envelopeVersion, bootstrap:binding.bootstrap,core:binding.core,root:binding.clientRoot,record:record,context:live.contextDigest,cipher:combined)
    ...
    static func inspect(_ data:Data, binding:RecoveryBinding, root:SymmetricKey) throws -> RecoveryEnvelopeBody {
        ...
        guard b.version == (try binding.envelopeVersion), crEqual(b.bootstrap,binding.bootstrap), crEqual(b.core,binding.core), crEqual(b.root,binding.clientRoot),
