...
public enum NativeRecoveryRuntime {
    ...
    public static func run(hostReceipt: String, hostDigest: String, clientReceipt: String, clientDigest: String,
        ...
        try witness?.requireSupportedOptions(requiredBoundary:requiredBoundary,allowedBoundary:allowedBoundary,fault:fault,fixture:fixture)
        try NativeRecoveryRoots.validateWitness(witness,hostReceipt:hostReceipt,hostDigest:hostDigest,clientReceipt:clientReceipt,clientDigest:clientDigest,fixture:fixture,stopWithPendingGuided:stopWithPendingGuided,requiredBoundary:requiredBoundary,duplicateExact:duplicateExact,original:original,stopAfterCalls:stopAfterCalls)
