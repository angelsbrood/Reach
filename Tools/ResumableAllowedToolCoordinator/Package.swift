...
let package = Package(
    name: "ResumableAllowedToolCoordinatorCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "AllowedToolWorker", targets: ["AllowedToolWorker"])],
    ...
    targets: [
        ...
        .target(name: "AllowedToolFixtures", dependencies: ["AllowedToolCoordinator", "RequiredToolCoordinator", "MLXLMCommon", "MLXLLM", "MLXGuidedGeneration", "ReachWire",
            .product(name: "MLX", package: "mlx-swift"), .product(name: "MLXNN", package: "mlx-swift")]),
        .executableTarget(name: "AllowedToolWorker", dependencies: ["AllowedToolFixtures", "AllowedToolCoordinator", "RequiredToolCoordinator", "MLXGuidedGeneration", "MLXLMCommon", "ReachWire",
            .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "AllowedToolCoordinatorTests", dependencies: ["AllowedToolFixtures", "AllowedToolCoordinator", "RequiredToolCoordinator", "MLXGuidedGeneration", "MLXLMCommon", "ReachWire",
            .product(name: "MLX", package: "mlx-swift")]),
    ],
