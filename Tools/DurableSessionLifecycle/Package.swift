...
let package = Package(
    name: "DurableSessionLifecycleCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "LifecycleWorker", targets: ["LifecycleWorker"])],
    ...
    targets: [
        ...
        .target(name: "DurableSessionLifecycle", dependencies: ["DurableHostStore", "ResumableMLXProvider", "ReachWire"]),
        ...
        .executableTarget(name: "LifecycleWorker", dependencies: ["DurableSessionLifecycle", "DurableHostStore", "LifecycleFixtures", "ResumableMLXProvider", "ReachWire", .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "DurableSessionLifecycleTests", dependencies: ["DurableSessionLifecycle", "DurableHostStore", "LifecycleFixtures", "ResumableMLXProvider", "AllowedToolCoordinator", "RequiredToolCoordinator", "MLXLMCommon", "MLXGuidedGeneration", "ReachWire", .product(name: "MLX", package: "mlx-swift")]),
    ],
