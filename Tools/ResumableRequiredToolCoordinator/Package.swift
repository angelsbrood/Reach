...
let package = Package(
    name: "ResumableRequiredToolCoordinatorCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "RequiredToolWorker", targets: ["RequiredToolWorker"])],
    ...
    targets: [
        ...
        .target(name: "RequiredToolFixtures", dependencies: ["RequiredToolCoordinator", "MLXLMCommon", "MLXLLM", "MLXGuidedGeneration", "ReachWire",
            .product(name: "MLX", package: "mlx-swift"), .product(name: "MLXNN", package: "mlx-swift")]),
        .executableTarget(name: "RequiredToolWorker", dependencies: ["RequiredToolFixtures", "RequiredToolCoordinator", "MLXGuidedGeneration", "MLXLMCommon", "ReachWire",
            .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "RequiredToolCoordinatorTests", dependencies: ["RequiredToolFixtures", "RequiredToolCoordinator", "MLXGuidedGeneration", "MLXLMCommon", "ReachWire",
            .product(name: "MLX", package: "mlx-swift")]),
    ],
