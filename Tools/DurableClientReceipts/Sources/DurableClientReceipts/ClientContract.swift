...
public final class FixtureClientClock: ClientClock {
    public let policy: String
    public var time: UInt64
    public init(id: String, time: UInt64) throws { try crID(id); self.policy = "fixture-ns-v1:"+id; self.time = time }
    public func now() throws -> UInt64 { guard time > 0 else { throw ClientError.invalid("clock") }; return time }
}
