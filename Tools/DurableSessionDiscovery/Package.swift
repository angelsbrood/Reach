...
let package = Package(
    name: "DurableSessionDiscoveryCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "KeychainWorker", targets: ["KeychainWorker"]), .executable(name: "HostRecoveryWorker", targets: ["HostRecoveryWorker"]), .executable(name: "ClientRecoveryWorker", targets: ["ClientRecoveryWorker"])],
    ...
    targets: [
        ...
        .target(name: "RecoveryFixtures", dependencies: ["DurableRootKeys", "DurableStoreBootstrap", "HostClientContract", "RecoveryContract", "DurableClientReceipts"]),
        .executableTarget(name: "KeychainWorker", dependencies: ["DurableRootKeys", "DurableStoreBootstrap", "RecoveryFixtures"]),
        .executableTarget(name: "ClientRecoveryWorker", dependencies: ["DurableRootKeys", "DurableStoreBootstrap", "RecoveryFixtures", "HostClientContract", "DurableClientReceipts"]),
        .executableTarget(name: "HostRecoveryWorker", dependencies: ["DurableRootKeys", "DurableStoreBootstrap", "RecoveryFixtures", "HostClientContract", "DurableClientReceipts", "DurableSessionLifecycle", "LifecycleFixtures", "ResumableMLXProvider", .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "DurableSessionDiscoveryTests", dependencies: ["DurableRootKeys", "DurableStoreBootstrap", "RecoveryFixtures", "RecoveryContract", "DurableClientReceipts", "HostClientContract"]),
    ],
