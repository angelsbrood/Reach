...
let package = Package(
    name: "MLXResumableGuidedGenerationCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "GuidedCheckpointWorker", targets: ["GuidedCheckpointWorker"])],
    ...
    targets: [
        ...
        .executableTarget(name: "GuidedCheckpointWorker", dependencies: ["MLXLMCommon", "MLXLLM", "MLXGuidedGeneration",
            .product(name: "MLX", package: "mlx-swift"),
            .product(name: "MLXNN", package: "mlx-swift"),
        ]),
        .testTarget(name: "MLXGuidedGenerationTests", dependencies: ["MLXLMCommon", "MLXLLM", "MLXGuidedGeneration",
            ...
            "ResumableGuidedGenerationTests.swift", "ResumableGuidedCheckpointTests.swift", "ResumableGrammarStateTests.swift", "ResumableGuidedTextStateTests.swift", "WhitespaceRunTrackerTests.swift", "WhitespaceTokenBiasTests.swift", "ClosingTokenBiasTests.swift", "ForcedCompletionTests.swift", "MaskRelocationTests.swift", "StopTokenSourceTests.swift", "ResumableGuidedModelStateTests.swift",
        ]),
    ],
