...
let package = Package(
    name: "DurableHostClientIntegrationCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "HostWorker", targets: ["HostWorker"]), .executable(name: "ClientWorker", targets: ["ClientWorker"])],
    ...
    targets: [
        ...
        .executableTarget(name: "HostWorker", dependencies: ["HostClientFixtures", "LifecycleFixtures", "DurableSessionLifecycle", "HostClientContract", "ResumableMLXProvider", .product(name: "MLX", package: "mlx-swift")]),
        .executableTarget(name: "ClientWorker", dependencies: ["DurableClientReceipts", "HostClientContract"]),
        .testTarget(name: "HostClientIntegrationTests", dependencies: ["HostClientFixtures", "LifecycleFixtures", "DurableSessionLifecycle", "DurableClientReceipts", "HostClientContract", "DurableHostStore", "ResumableMLXProvider", "ReachWire", .product(name: "MLX", package: "mlx-swift")]),
    ],
