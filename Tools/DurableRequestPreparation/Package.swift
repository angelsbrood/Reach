...
let package = Package(
    name: "DurableRequestPreparationCandidate",
    platforms: [.macOS("27.0")],
    products: [.executable(name: "PreparationWorker", targets: ["PreparationWorker"]), .executable(name: "KeychainWorker", targets: ["KeychainWorker"]), .executable(name: "HostWireWorker", targets: ["HostWireWorker"]), .executable(name: "ClientWireWorker", targets: ["ClientWireWorker"])],
