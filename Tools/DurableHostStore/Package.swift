...
let package = Package(
    name: "DurableHostStoreCandidate",
    platforms: [.macOS(.v14)],
    products: [.executable(name: "StoreWorker", targets: ["StoreWorker"])],
    ...
    targets: [
        ...
        .target(name: "StoreFixtures", dependencies: ["DurableHostStore", "ResumableMLXProvider", "AllowedToolCoordinator", "RequiredToolCoordinator", "MLXLMCommon", "MLXLLM", "MLXGuidedGeneration", "ReachWire",
            .product(name: "MLX", package: "mlx-swift"), .product(name: "MLXNN", package: "mlx-swift")]),
        .executableTarget(name: "StoreWorker", dependencies: ["DurableHostStore", "StoreFixtures", "ResumableMLXProvider", "ReachWire", .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "DurableHostStoreTests", dependencies: ["DurableHostStore", "StoreFixtures", "ResumableMLXProvider", "AllowedToolCoordinator", "RequiredToolCoordinator", "MLXLMCommon", "MLXGuidedGeneration", "ReachWire", .product(name: "MLX", package: "mlx-swift")]),
    ],
