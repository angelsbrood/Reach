...
let package = Package(
    name: "DurableSchemaToolPreparationCandidate",
    platforms: [.macOS("27.0")],
    products: [.executable(name: "SchemaToolPreparationWorker", targets: ["SchemaToolPreparationWorker"]), .executable(name: "AllowedPreparationWorker", targets: ["AllowedPreparationWorker"]), .executable(name: "SchemaPreparationWorker", targets: ["SchemaPreparationWorker"]), .executable(name: "PreparationWorker", targets: ["PreparationWorker"]), .executable(name: "KeychainWorker", targets: ["KeychainWorker"]), .executable(name: "HostWireWorker", targets: ["HostWireWorker"]), .executable(name: "ClientWireWorker", targets: ["ClientWireWorker"])],
    ...
    targets: [
        ...
        .target(name: "SchemaToolPreparationFixtures", dependencies: ["AllowedPreparationFixtures", "RequestPreparationFixtures", "RequestPreparationContract", "DurableRequestPreparation", "LifecycleFixtures", "AllowedToolCoordinator", "ResumableMLXProvider", "WireAdapterContract", "DurableHostWireAdapter", "ReachWire", "MLXLMCommon", "MLXGuidedGeneration", .product(name: "MLX", package: "mlx-swift")]),
        .executableTarget(name: "SchemaToolPreparationWorker", dependencies: ["SchemaToolPreparationFixtures", "RequestPreparationFixtures", "RequestPreparationContract", "ReachWire", "ResumableMLXProvider", .product(name: "MLX", package: "mlx-swift")]),
        .testTarget(name: "DurableSchemaToolPreparationTests", dependencies: ["SchemaToolPreparationFixtures", "AllowedPreparationFixtures", "SchemaPreparationFixtures", "RequestPreparationFixtures", "RequestPreparationContract", "DurableRequestPreparation", "ReachWire", "AllowedToolCoordinator", "ResumableMLXProvider", "WireAdapterContract", "DurableHostWireAdapter", "DurableClientWireAdapter", "DurableClientReceipts", "DurableSessionLifecycle", "HostClientContract", "RecoveryContract", "MLXLMCommon", "MLXGuidedGeneration", .product(name: "MLX", package: "mlx-swift")]),
