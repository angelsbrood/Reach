...
struct Reachd: AsyncParsableCommand {
    static let configuration = CommandConfiguration(
        ...
        subcommands: [DurableIndependent.self, DurableTransport.self, DurableLocal.self, Serve.self, Pair.self, Status.self, Doctor.self, CA.self, Selftest.self, Service.self, Mesh.self]
    )
}
