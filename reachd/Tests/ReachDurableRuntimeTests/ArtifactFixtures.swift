...
enum ArtifactFixtures {
    static func base() throws -> String {
        guard let path=ProcessInfo.processInfo.environment["S93_TEST_ROOT"],(path.hasPrefix("/private/tmp/reach-s93.") || path.hasPrefix("/private/tmp/reach-s94.") || path.hasPrefix("/private/tmp/reach-s95.") || path.hasPrefix("/private/tmp/reach-s96.") || path.hasPrefix("/private/tmp/reach-s97.") || path.hasPrefix("/private/tmp/reach-s98.")),path.hasSuffix("/fixtures") else { throw LocalRuntimeError.invalid }
