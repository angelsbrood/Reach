...
enum ArtifactFixtures {
    static func base() throws -> String {
        guard let path=ProcessInfo.processInfo.environment["S93_TEST_ROOT"],path.hasPrefix("/private/tmp/reach-s93."),path.hasSuffix("/fixtures") else { throw LocalRuntimeError.invalid }
