...
public struct LMOutput {
    ...
    public struct State {
        ...
        // Module-internal access for the opt-in typed checkpoint codec registry.
        // Legacy typed-key reads and writes retain their existing behavior.
        var checkpointContents: [String: Any] { contents }

        init(checkpointContents: [String: Any]) {
            self.contents = checkpointContents
        }
